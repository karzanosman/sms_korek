<div>
    ...
    @endif
        ...
        <form wire:submit.prevent="submit">
            ...
            <input type="text"  wire:model.defer="sms_title" class="form-control form-control-lg my-1" placeholder="SMS Title">


            <label> Offer Name </label>

            <input type="text" wire:model.defer="offer_name" class="form-control form-control-lg my-1" placeholder="Offer Name">


            <label> SMS Content </label>

           <textarea cols="30" wire:model.defer="sms_content" rows="10" class="form-control my-1" placeholder="SMS Content"></textarea>
